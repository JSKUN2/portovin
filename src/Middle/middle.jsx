...
export default function Middle(){
    ...
    return(<>
      {Mobile ? (
        ...
        <div className="flex flex-row gap-[12px] translate-x-[-210px]">
            <SpotlightCard className="custom-spotlight-card w-[260px] h-[132px] shrink-0 passive" spotlightColor="#BAD1FF" />
            
            <SpotlightCard className="custom-spotlight-card w-[260px] h-[132px] shrink-0 active text-[12px] leading-[157%] tracking-[12%] text-[#FFF9F8] align-center justify-center" spotlightColor="#BAD1FF">
            <br />Currently working at Grooth Studio, developing a 2D pixel-based game with Unity Engine. Project still in progress.
            </SpotlightCard>
