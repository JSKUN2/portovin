    ...
    return(
        <div className='bg-[white] w-[100vw] font-montserrat'>
            <div className='translate-x-40 flex flex-row gap-[22px]'>
                <SpotlightCard className="custom-spotlight-card w-[520px] h-[221px] active font-medium text-[22px] leading-[157%] tracking-[12%] text-[#FFF9F8] align-center justify-end" spotlightColor="#BAD1FF">
