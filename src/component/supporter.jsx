...
export default function Supporter() {
  return (
    <FadeContent blur={true} duration={1000} easing="ease-out" initialOpacity={0} >
        ...
        <h1 className="text-[1.55vw] max-md:text-[5.6vw] text-center">Special Thanks to Our Donors</h1>
        <h1 className="opacity-[0.6] text-[1.2vw] max-md:text-[3vw] text-center">
        ...
        <CurvedLoop
            ...
            direction="right"
            interactive={false}
            className="custom-text-style mt-10 max-md:mt-6 text-[1.1vw] max-md:text-[3.2vw]"
        />
        </div>
    </FadeContent>
  );
