...
useEffect(() => {
    ...
    return(
        <div className="max-md:h-screen md:h-screen w-screen flex flex-col justify-between items-center pt-0 relative">
              <StaggeredMenu
    position="right"
    items={menuItems}
  ...
  />
            <div className="flex w-[80vw] flex-row max-md:flex-col h-[360px] absolute top-88 left-1/2 -translate-x-1/2 -translate-y-1/2 justify-center items-center">
                ...
                <FadeContent blur={true} duration={1000} easing="ease-out" initialOpacity={0} className="flex flex-row w-[90%] h-[64px] absolute bottom-16 justify-between">
