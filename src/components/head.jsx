...
useEffect(() => {
    ...
    return(
        <div className="h-[100vh] w-screen flex flex-col justify-center items-center pt-0 relative">
              <StaggeredMenu
    position="right"
    items={menuItems}
    ...
    active={active}
  />
            <div className="flex w-[80vw] flex-row max-md:flex-col h-[360px] absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 justify-around items-center">
                ...
                <FadeContent blur={true} duration={1000} easing="ease-out" initialOpacity={0} className="flex flex-row w-[90%] h-[64px] justify-between absolute bottom-0">
